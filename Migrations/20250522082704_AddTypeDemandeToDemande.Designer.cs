...
namespace TisCircuitsAPI.Migrations
{
    ...
    [Migration("20250522082704_AddTypeDemandeToDemande")]
    partial class AddTypeDemandeToDemande
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TisCircuitsAPI.Models.Quiz", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TisCircuitsAPI.Models.QuizOption", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TisCircuitsAPI.Models.QuizQuestion", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TisCircuitsAPI.Models.QuizResult", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TisCircuitsAPI.Models.QuizOption", b =>
                {
                    b.HasOne("TisCircuitsAPI.Models.QuizQuestion", "QuizQuestion")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("TisCircuitsAPI.Models.QuizQuestion", b =>
                {
                    b.HasOne("TisCircuitsAPI.Models.Quiz", "Quiz")
                        .WithMany("Questions")
